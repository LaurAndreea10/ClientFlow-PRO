...
Use these 4 captures in the README:

1. mobile dashboard in dark mode
2. clients page with filters visible
3. tasks page while editing a task
4. settings page in light mode

That combination shows responsiveness, CRUD, UI polish and theme support quickly.


## New in v7

- Added a mobile-friendly **Reports / Analytics** page
- Filters for client status, task status, and priority
- Revenue and workload charts powered by local demo data
- Still zero required paid services and no backend setup


## New in v8
- Calendar / Timeline page for deadlines and client notes
- Weekly planning cards optimized for mobile
- Still local-first and free to run
