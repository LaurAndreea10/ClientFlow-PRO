...
- Next action`,
    ...
    },
    {
      ...
      status: 'lead',
      monthlyValue: 450,
      tags: ['proposal', 'frontend'],
      isFavorite: false,
      isArchived: false,
      notesTemplate: `Discovery template:
- Need
- Budget
- Timeline`,
      createdAt: new Date().toISOString(),
  ...
  const tasks: Task[] = [
    {
      ...
      subtaskTitles: ['Create static variants', 'Review mobile crop', 'Send for approval'],
      attachmentNames: ['brief.pdf', 'draft-copy.docx'],
      isArchived: false,
      createdAt: new Date().toISOString(),
    },
    {
      ...
      recurrence: 'none',
      tags: ['sales'],
      subtaskTitles: ['Draft pricing table', 'Review scope'],
      attachmentNames: ['proposal-v2.pdf'],
      isArchived: false,
      createdAt: new Date().toISOString(),
    },
    {
      ...
      recurrence: 'monthly',
      tags: ['ops'],
      subtaskTitles: ['Review labels', 'Test on mobile'],
      attachmentNames: [],
      isArchived: false,
      createdAt: new Date().toISOString(),
    },
